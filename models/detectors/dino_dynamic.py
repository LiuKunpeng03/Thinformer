...
from .deformable_detr_dynamic import DeformableDETRDynamic, MultiScaleDeformableAttention


@MODELS.register_module()
class DINODynamic(DeformableDETRDynamic):
    ...
    def init_weights(self) -> None:
        ...
        super(DeformableDETRDynamic, self).init_weights()
